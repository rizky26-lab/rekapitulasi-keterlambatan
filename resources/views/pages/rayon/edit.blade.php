            ...
            <div class="row row-cols-1 row-cols-lg-2">
                ...
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('rayon') is-invalid @enderror" name="rayon" id="rayon" placeholder="Masukkan rayon" value="{{ old('rayon') ? old('rayon') : $rayon->rayon }}">
                        @error('rayon')<span class="text-danger d-block">{{ $message }}</span>@enderror
                    </div>
                </div>
                <div class="col">
                    <div class="mb-3">
