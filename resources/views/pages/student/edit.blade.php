            ...
            <div class="row row-cols-1 row-cols-lg-2">
                ...
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nis') is-invalid @enderror" name="nis" id="nis" placeholder="Masukkan nis" value="{{ old('nis') ? old('nis') : $student->nis }}">
                ...
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="Masukkan nama" value="{{ old('name') ? old('name') : $student->name }}">
